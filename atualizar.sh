...
[ $(id -u) -ne 0 ] && { echo "Esse script deve ser executado como root!"; exit; }
...
case "$ID $ID_LIKE" in
    *arch|*artix* )
        ...
        pacman -Rsn $(pacman -Qdtq) --noconfirm 2>/dev/null; pacman -Scc --noconfirm
    ...
    *debian*|*ubuntu* )
        ...
        apt purge --autoremove -y; apt autoclean -y; apt clean
    ...
    *gentoo* )
        ...
        emerge -a --depclean; emerge -a --clean; eclean distfiles
